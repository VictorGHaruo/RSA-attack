...
adequado, que pode ser obtido pelo algoritmo estendido de Euclides. Portanto,
o atacante pode computar
\[
...
Assim, se dois usuários compartilham o mesmo módulo $n$ e cifram a mesma 
mensagem com expoentes públicos coprimos $e_1$ e $e_2$, então qualquer atacante 
que intercepte $(c_1,c_2,e_1,e_2,n)$ pode recuperar a mensagem $m$, violando 
completamente a segurança do RSA nesse cenário.

% \subsection*{Implementação de teste}
